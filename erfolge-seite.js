...
function renderErfolge() {
    ...
    for (let id in alleErfolge) {
        ...
        let karte = document.createElement("div");
        karte.className = "erfolg-karte" + (istFreigeschaltet ? " freigeschaltet" : "") + " seltenheit-" + erfolg.seltenheit;
...
karte.innerHTML =
    ...
    "<div class='erfolg-info'>" +
        "<h3>" + titel + "</h3>" +
        "<p>" + beschreibung + "</p>" +
        (istVersteckt ? "" : "<span class='seltenheit-label seltenheit-" + erfolg.seltenheit + "'>" + seltenheitLabel[erfolg.seltenheit] + "</span>") +
    "</div>" +
    "<div class='erfolg-coins'>" + coinsText + "</div>";
